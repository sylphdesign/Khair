...
<section className="sp-hero"><div className="hero-grain"></div><div className="sp-hero-in"><p className="sp-bc"><Link href="/">Home</Link> &nbsp;/&nbsp; Shipping Info</p><h1>Shipping <em>Information</em></h1><p>Plain packaging. Reliable tracking. Complete peace of mind.</p></div></section>
...
<div className="sp-cta"><div><h2>Discreet from Start <em>to Finish</em></h2><p>Your privacy matters at every step.</p><Link href="/contact" className="sp-btn"><span>Contact Us</span><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M5 12h14M12 5l7 7-7 7"/></svg></Link></div></div>
    </div>
  );
}
