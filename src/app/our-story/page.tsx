...
<div className="sp-mgrid sp-rv" style={{margin: '50px 0', gap: '24px'}}><div className="sp-iph" style={{aspectRatio: '4/3'}}><div className="sp-iph"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><path d="M21 15l-5-5L5 21"/></svg><span>Founder's Journey</span></div></div><div className="sp-iph" style={{aspectRatio: '4/3'}}><div className="sp-iph"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><path d="M21 15l-5-5L5 21"/></svg><span>Finished Piece</span></div></div></div>
...
<div className="sp-cta"><div><h2>Every Wig Tells <em>a Story</em></h2><p>Let us help you write the next chapter of yours.</p><Link href="/contact"><span>Start the Conversation</span><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 12h14M12 5l7 7-7 7"/></svg></Link></div></div>
    </div>
  );
}
