...
<div className="sp-cta"><div><h2>Questions About <em>Terms?</em></h2><p>We're happy to clarify anything.</p><Link href="/contact" className="sp-btn"><span>Get in Touch</span><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M5 12h14M12 5l7 7-7 7"/></svg></Link></div></div>
    </div>
  );
}
