...
<div className="sp-cta"><div><h2>Invest in What <em>Matters</em></h2><p>Proper care keeps your piece looking flawless, wear after wear.</p><Link href="/contact" className="sp-btn"><span>Get Personalized Care Advice</span><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M5 12h14M12 5l7 7-7 7"/></svg></Link></div></div>
    </div>
  );
}
