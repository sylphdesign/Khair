...
<div className="sp-cta"><div><h2>We Stand Behind <em>Every Piece</em></h2><p>Satisfaction isn't optional — it's the whole point.</p><Link href="/contact" className="sp-btn"><span>Contact Us</span><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M5 12h14M12 5l7 7-7 7"/></svg></Link></div></div>
    </div>
  );
}
