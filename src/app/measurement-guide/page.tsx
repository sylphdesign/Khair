...
<div><div className="sp-iph sp-rv" style={{aspectRatio: '1/1', position: 'sticky', top: '120px'}}><div className="sp-iph"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><path d="M21 15l-5-5L5 21"/></svg><span>Measurement Diagram</span></div></div></div>
</div>
...
<Link href="/contact"><span>Book Measurement Session</span><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 12h14M12 5l7 7-7 7"/></svg></Link></div>
</div>
<div className="sp-cta"><div><h2>The Right Fit Makes <em>Everything</em></h2><p>Five minutes of measuring. Years of confidence.</p><Link href="/contact"><span>Get Started</span><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 12h14M12 5l7 7-7 7"/></svg></Link></div></div>
    </div>
  );
}
