...
<div className="sp-pcard sp-rv" data-cat="Straight"><div className="sp-pimg"><div className="sp-iph"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><path d="M21 15l-5-5L5 21"/></svg><span>Product</span></div><div className="sp-badge">Signature</div></div><div className="sp-pinfo"><h3>European Silky Straight</h3><p>18" · Color 1B Natural Virgin · 130% Density</p><p style={{fontSize: '.75rem', color: 'var(--text-light)'}}>Full Lace · Proprietary Scalp Tech</p></div></div>
<div className="sp-pcard sp-rv" data-cat="Wavy"><div className="sp-pimg"><div className="sp-iph"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><path d="M21 15l-5-5L5 21"/></svg><span>Product</span></div><div className="sp-badge">Popular</div></div><div className="sp-pinfo"><h3>Natural Body Wave</h3><p>20" · Custom Color Match · 150% Density</p><p style={{fontSize: '.75rem', color: 'var(--text-light)'}}>Full Lace · Custom Fit Available</p></div></div>
<div className="sp-pcard sp-rv" data-cat="Curly"><div className="sp-pimg"><div className="sp-iph"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><path d="M21 15l-5-5L5 21"/></svg><span>Product</span></div><div className="sp-badge">New</div></div><div className="sp-pinfo"><h3>Deep Curl Luxury</h3><p>22" · Virgin European · 130% Density</p><p style={{fontSize: '.75rem', color: 'var(--text-light)'}}>Full Lace · Baby Hair Detail</p></div></div>
<div className="sp-pcard sp-rv" data-cat="Straight"><div className="sp-pimg"><div className="sp-iph"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><path d="M21 15l-5-5L5 21"/></svg><span>Product</span></div></div><div className="sp-pinfo"><h3>Classic Straight Long</h3><p>24" · Color 2 Darkest Brown · 130% Density</p><p style={{fontSize: '.75rem', color: 'var(--text-light)'}}>Full Lace · Proprietary Scalp Tech</p></div></div>
<div className="sp-pcard sp-rv" data-cat="Wavy"><div className="sp-pimg"><div className="sp-iph"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><path d="M21 15l-5-5L5 21"/></svg><span>Product</span></div></div><div className="sp-pinfo"><h3>Soft Wave Bob</h3><p>14" · Color 1B Natural · 150% Density</p><p style={{fontSize: '.75rem', color: 'var(--text-light)'}}>Full Lace · Lightweight Cap</p></div></div>
<div className="sp-pcard sp-rv" data-cat="Curly"><div className="sp-pimg"><div className="sp-iph"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><path d="M21 15l-5-5L5 21"/></svg><span>Product</span></div></div><div className="sp-pinfo"><h3>Romantic Loose Curl</h3><p>20" · Custom Color · 130% Density</p><p style={{fontSize: '.75rem', color: 'var(--text-light)'}}>Full Lace · Hand-Tied Throughout</p></div></div>
</div>
...
<Link href="/custom-orders"><span>Start a Custom Order</span><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M5 12h14M12 5l7 7-7 7"/></svg></Link></div>
</div>
